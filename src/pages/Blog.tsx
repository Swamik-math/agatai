...
const categoryTabs: BlogFilter[] = ["All", "Company", "Product", "Engineering", "Creator Series"];

const featuredStory: BlogPost = {
	id: 0,
	title: "Frontier AI Labs Form New Safety Compact Around Autonomous Agent Deployments",
	summary:
...
const klingHighlights: BlogPost[] = [
	{
		id: 101,
		title: "Kling AI 1.7 Adds Longer Shot Continuity for Character-Locked Video",
		summary:
	...
	{
		id: 102,
		title: "Kling AI Studio Introduces Motion Brush Controls for Precision Edits",
		summary:
...
const blogPosts: BlogPost[] = [
	{
		id: 1,
		title: "Open-Weight Reasoning Models Reach 1M Context on Commodity Clusters",
		summary:
	...
	{
		id: 2,
		title: "Meta-Agents Move From Demo to Production in Customer Support Stacks",
		summary:
	...
	{
		id: 4,
		title: "Creator Series: Filmmakers Use Diffusion Video Pipelines for Full Previs",
		summary:
	...
	{
		id: 5,
		title: "AI Chip Roadmap 2026: Memory Bandwidth Becomes the New Battleground",
		summary:
	...
	{
		id: 6,
		title: "Product Update: Realtime Voice Agents Now Support Regional Compliance Modes",
		summary:
	...
	{
		id: 7,
		title: "Company Brief: Enterprise AI Budgets Shift from Pilots to Platform Teams",
		summary:
	...
	{
		id: 8,
		title: "Creator Series: Generative Sound Design Finds Its Place in AAA Workflows",
		summary:
	...
	{
		id: 9,
		title: "Engineering Note: Prompt Caching Cuts Inference Costs by 37% at Scale",
		summary:
	...
	{
		id: 11,
		title: "Multimodal Search Becomes Core UX Layer in Enterprise Knowledge Apps",
		summary:
	...
	{
		id: 12,
		title: "Edge AI Phones Launch with On-Device Diffusion for Private Generation",
		summary:
	...
	{
		id: 13,
		title: "Engineering Deep Dive: Hybrid RAG Architectures Beat Baseline Accuracy by 22%",
		summary:
	...
	{
		id: 14,
		title: "Creator Series: Indie Studios Train Style-Safe Models with Rights-Cleared Libraries",
		summary:
	...
	{
		id: 16,
		title: "Tech Funding Watch: AI Infrastructure Startups See Strongest Quarter Since 2024",
		summary:
	...
	{
		id: 17,
		title: "Wearable Tech Meets AI: Real-Time Health Copilots Expand into Preventive Care",
		summary:
	...
	{
		id: 18,
		title: "Creator Series: Game Teams Use Generative NPC Dialogue with Live Guardrails",
		summary:
	...
	{
		id: 19,
		title: "Cybersecurity Teams Adopt AI SOC Analysts to Reduce False Positives",
		summary:
				...
				<section className="blog-featured" aria-label="Featured story">
					...
					>
						<div className="blog-featured-image-wrap">
							<img src={featuredStory.image} alt={featuredStory.title} loading="lazy" />
						</div>
						<div className="blog-featured-body">
							...
							<div className="blog-meta">
								<span className="blog-pill subdued">{featuredStory.category}</span>
								<time dateTime={featuredStory.dateIso}>{featuredStory.dateLabel}</time>
					...
					<div className="blog-modal-overlay" onClick={() => setSelectedPost(null)}>
						...
						>
							...
							<div className="blog-meta blog-modal-meta">
								<span className="blog-pill subdued">{selectedPost.category}</span>
								<time dateTime={selectedPost.dateIso}>{selectedPost.dateLabel}</time>
								<span className="blog-dot" aria-hidden="true" />
